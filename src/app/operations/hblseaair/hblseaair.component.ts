...
export class HblSeaAirComponent {
    ...
    GetMasterData(Id: string) {
        ...
        this.mainService.GetMasterData(SearchData)
            .subscribe(response => {
                ...
                this.Record.hbl_agent_br_id = _Rec.hbl_agent_br_id;
                this.Record.hbl_agent_br_no = _Rec.hbl_agent_br_no;
                this.Record.hbl_agent_br_addr = _Rec.hbl_agent_br_addr;
                ...
                this.Record.hbl_mbl_bookslno = _Rec.hbl_mbl_bookslno
    ...
    CheckCrLimit(bCallSave: boolean = false) {
        ...
        let SearchData = {
            ...
            consigneeid: this.Record.hbl_imp_id
        };
