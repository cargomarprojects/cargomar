...
@Component({
  selector: 'app-gstreconrep-cdnr',
  templateUrl: './gstreconrep-cdnr.component.html'
})

export class GstReconRepCdnrComponent {
  ...
  UpdatePurchaseData() {
    ...
    if (!confirm("Do you want to Update Purchase Data - " + this.gs.defaultValues.gst_recon_cdnr_state_name + " - " + this.getMonth(this.gs.defaultValues.gst_recon_cdnr_month) + ", " + this.gs.defaultValues.gst_recon_cdnr_year)) {
      return;
    }
    ...
    SearchData2.to_date = '';
    SearchData2.format_type = 'CI-SUMMARY';
