...
export class GstReconRepRcComponent {
    ...
    LovSelected(_Record: SearchTable) {
        if (_Record.controlname == "STATE") {
            this.gs.defaultValues.gst_recon_rc_state_code = _Record.code;
            this.gs.defaultValues.gst_recon_rc_state_name = _Record.name;
        }
    }
    LoadCombo() {
    ...
    // // Query List Data
    List(_type: string) {
        if (this.gs.isBlank(this.gs.defaultValues.gst_recon_rc_state_name)) {
            alert("State Cannot be Blank");
            return;
        }
        if (+this.gs.defaultValues.gst_recon_rc_year <= 0) {
            alert("Invalid Year");
            return;
        } else if (+this.gs.defaultValues.gst_recon_rc_year < 100) {
            alert("YEAR FORMAT : - YYYY ");
            return;
        }
        if (+this.gs.defaultValues.gst_recon_rc_month <= 0 || +this.gs.defaultValues.gst_recon_rc_month > 12) {
            alert("Invalid Month");
            return;
        }
        ...
        this.SearchData.searchstring = this.gs.defaultValues.gst_recon_rc_searchstring.toUpperCase();
        this.SearchData.type = _type;
        this.SearchData.from_date = this.from_date;
        this.SearchData.to_date = this.to_date;
        this.SearchData.format_type = this.format_type;
        this.SearchData.user_code = this.gs.globalVariables.user_code;
        this.SearchData.state_code = this.gs.defaultValues.gst_recon_rc_state_code;
        this.SearchData.state_name = this.gs.defaultValues.gst_recon_rc_state_name;
        this.SearchData.round_off = this.round_off;
        this.SearchData.recon_year = +this.gs.defaultValues.gst_recon_rc_year;
        this.SearchData.recon_month = +this.gs.defaultValues.gst_recon_rc_month;
        ...
        this.mainService.List(this.SearchData)
            .subscribe(response => {
                ...
                if (_type == 'EXCEL') {
                    ...
                    this.mainService.RecordListRc = response.list;
                }
            },
                error => {
                    this.loading = false;
                    this.mainService.RecordListRc = null;
                    this.ErrorMessage = this.gs.getError(error);
    ...
    OnBlur(field: string) {
        if (field == "searchstring")
            this.gs.defaultValues.gst_recon_rc_searchstring = this.gs.defaultValues.gst_recon_rc_searchstring.toUpperCase();
    }
    ...
    ProcessGstReconcile() {
        ...
        if (!confirm("Do you want to Process Data - " + this.gs.defaultValues.gst_recon_rc_state_name + " - " + this.getMonth(this.gs.defaultValues.gst_recon_rc_month) + ", " + this.gs.defaultValues.gst_recon_rc_year)) {
            return;
        }
    ...
    UpdatePurchaseData() {
        ...
        if (!confirm("Do you want to Update Purchase Data - " + this.gs.defaultValues.gst_recon_rc_state_name + " - " + this.getMonth(this.gs.defaultValues.gst_recon_rc_month) + ", " + this.gs.defaultValues.gst_recon_rc_year)) {
            return;
        }
        ...
        SearchData2.state_code = this.gs.defaultValues.gst_recon_rc_state_code;
        SearchData2.state_name = this.gs.defaultValues.gst_recon_rc_state_name;
        SearchData2.round_off = this.round_off;
        SearchData2.hide_ho_entries = this.gs.globalVariables.hide_ho_entries;
        SearchData2.recon_year = +this.gs.defaultValues.gst_recon_rc_year;
        SearchData2.recon_month = +this.gs.defaultValues.gst_recon_rc_month;
