...
import { TeuClr } from '../models/teuclr';

import { RepService } from '../services/report.service';

@Component({
  selector: 'app-teuclr',
  templateUrl: './teuclr.component.html',
  providers: [RepService]
})

export class TeuClrComponent {
  title = 'TeuClr Report'
  ...
  List(_type: string) {
    ...
    this.ErrorMessage = '';
    this.mainService.TeuClrList(this.SearchData)
      .subscribe(response => {
        this.loading = false;
        if (_type == 'EXCEL')
