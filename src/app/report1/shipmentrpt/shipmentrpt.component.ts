...
import { ShipmentReport } from '../models/shipmentreport';
import { RepService } from '../services/report.service';
import { DateComponent } from '../../shared/date/date.component';

@Component({
    selector: 'app-shipmentrpt',
    templateUrl: './shipmentrpt.component.html',
...
export class ShipmentReportComponent {
    ...
    RecordList: ShipmentReport[] = [];
    //  Single Record for add/edit/view details
    Record: ShipmentReport = new ShipmentReport;
