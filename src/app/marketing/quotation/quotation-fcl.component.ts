...
import { QuotationFclService } from '../services/quotationfcl.service';
...
@Component({
    ...
    templateUrl: './quotation-fcl.component.html',
    providers: [QuotationFclService]
})
export class QuotationFclComponent {
    ...
    constructor(
        ...
        private mainService: QuotationFclService,
