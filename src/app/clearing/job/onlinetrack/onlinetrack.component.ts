...
import { OnlineTrackService } from '../../services/onlinetrack.service';
import { SearchTable } from '../../../shared/models/searchtable';

@Component({
  selector: 'app-onlinetrack',
  templateUrl: './onlinetrack.component.html',
  providers: [OnlineTrackService]
})
export class OnlineTrackComponent {
  // Local Variables 
  title = 'Tracking List';
  ...
  constructor(
    ...
    private mainService: OnlineTrackService,
