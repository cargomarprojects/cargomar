...
@Component({
  selector: 'app-jobpackinglist',
  templateUrl: './jobpackinglist.component.html',
  providers: [JobPackingListService]
})
export class JobPackingListComponent {
  // Local Variables 
  title = 'Packing List';
  ...
  Record: JobPackinglist = new JobPackinglist;

  PKGUNITRECORD: SearchTable = new SearchTable();

  constructor(
    private mainService: JobPackingListService,
  ...
  NewRecord() {
    ...
    this.Record = new JobPackinglist();
