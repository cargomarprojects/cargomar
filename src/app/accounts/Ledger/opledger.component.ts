...
import { OpLedgerService } from '../services/opledger.service';
import { SearchTable } from '../../shared/models/searchtable';

@Component({
  selector: 'app-opledger',
  templateUrl: './opledger.component.html',
  encapsulation: ViewEncapsulation.None,
  providers: [OpLedgerService]
})
export class OpLedgerComponent {
  // Local Variables 
  ...
  constructor(
    ...
    private mainService: OpLedgerService,
