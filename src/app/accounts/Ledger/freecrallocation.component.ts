...
@Component({
  selector: 'app-freecrallocation',
  templateUrl: './freecrallocation.component.html',
  providers: [FreeAllocationService]
})

export class FreeCrAllocationComponent {
  // Local Variables 
  title = 'Allocation';
  ...
  Save() {
    ...
    this.PendingList.forEach(Rec => {
      if (Rec.jv_selected && Rec.jv_allocation > 0) {
        ...
        this.xRefRec.xref_cr_jvh_id = Rec.jv_parent_id;
        this.xRefRec.xref_cr_jv_id = Rec.jv_pkid;
        this.xRefRec.xref_cr_jv_year = Rec.jv_year;
        this.xRefRec.xref_cr_jv_date = Rec.jv_date;

        this.xRefRec.xref_dr_jvh_id = mRec.jv_parent_id;
        this.xRefRec.xref_dr_jv_id = mRec.jv_pkid;
        this.xRefRec.xref_dr_jv_year = mRec.jv_year;
        this.xRefRec.xref_dr_jv_date = mRec.jv_date;

        this.xRefRec.xref_amt = Rec.jv_allocation;

        this.xRefRec.xref_adv_amt = 0;

        this.xRefRec.xref_drcr = 'CR';
