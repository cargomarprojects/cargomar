...
import * as LedgerReportActions from './cashbook.actions';
import { LedgerReportState } from './cashbook.model'

export interface AppState extends AppState {
    'cashbook': LedgerReportState
}
...
export function CashBookReportreducer(state: LedgerReportState[] = [initialState], action: LedgerReportActions.LedgerReportActions): LedgerReportState [] {
  switch (action.type) {
...
export const getLedgerReportState = createFeatureSelector<LedgerReportState[]>('cashbook');
