...
export class ArrearsComponent {
  ...
  Record: Arrearsm = new Arrearsm;
  Recorddet: ArrDet = new ArrDet;

  constructor(
    private mainService: ArrearsService,
  ...
  RefreshList() {
    if (this.RecordList == null)
      return;
    var REC = this.RecordList.find(rec => rec.arr_pkid == this.Record.arr_pkid);
    if (REC == null) {
      ...
      REC.arr_gross_earn = this.Record.arr_gross_earn;
      REC.arr_gross_deduct = this.Record.arr_gross_deduct;
      REC.arr_net = this.Record.arr_net;
    }
  }
